									...
									<tr>
										...
										<![endif]-->
											<?php if ( $is_notification ) : ?>
												<a href="<?php echo HARBINGER_MARKETING_WEBSITE_URL ?>" target="_blank" style="display: inline-block; width: 100%; max-width: 150px; margin-top: 15px; margin-bottom: 15px; margin-left: 25px; margin-right: 25px; vertical-align: middle;">
													<?php $harbinger_marketing_logo_url = get_svg_as_colorized_png( HARBINGER_MARKETING_LOGO_PATH, 'white' ) ?>

													<img src="<?php echo $harbinger_marketing_logo_url ?>" alt="" style="display: block;" width="150" height="<?php echo 150 / get_image_aspect_ratio( $harbinger_marketing_logo_url ) ?>">
												</a>
											<?php endif ?>
										<!--[if mso]>
										</td>
										...
										<![endif]-->
											<a href="<?php bloginfo('url') ?>" target="_blank" style="display: inline-block; width: 100%; max-width: 150px; margin-top: 15px; margin-bottom: 15px; margin-left: 25px; margin-right: 25px; vertical-align: middle;">
												<img src="<?php echo THEME_LOGO_RASTER_WHITE_URL ?>" alt="" style="display: block;" width="150" height="<?php echo 150 / get_image_aspect_ratio( THEME_LOGO_RASTER_WHITE_URL ) ?>">
											</a>
										<!--[if mso]>
										</td>
									</tr>
