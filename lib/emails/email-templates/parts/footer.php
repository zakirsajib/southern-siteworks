							...
							<td style="text-align: center; padding: 20px 0;">
								<a href="<?php echo $is_notification ? HARBINGER_MARKETING_WEBSITE_URL : get_bloginfo('url') ?>" target="_blank" style="display: block; width: 100%; max-width: 120px; margin: 0 auto;">
									<?php if ( $is_notification ) : ?>
										...
										<img src="<?php echo $harbinger_logo_url ?>" alt="" style="display: block;" width="120" height="<?php echo 120 / get_image_aspect_ratio( $harbinger_logo_url ) ?>">
									<?php else : ?>
										<img src="<?php echo THEME_LOGO_RASTER_COLORFUL_URL ?>" alt="" style="display: block;" width="120" height="<?php echo 120 / get_image_aspect_ratio( THEME_LOGO_RASTER_COLORFUL_URL ) ?>">
									<?php endif ?>
								</a>
							</td>
						</tr>
