...
function initMap() {
    ...
    const markerImage = "https://southernsiteworks.demo.harbingermarketing.com/wp-content/uploads/2021/12/marker.svg"; // will change on live mode
    ...
    const beachMarker = new google.maps.Marker({
        ...
        //label: { color: '#1B5FBA', fontFamily: 'Saira' ,fontWeight: 'bold', fontSize: '20px', text: '75 miles' },
        map,
        icon: markerImage
    });
    ...
    southernsiteworksOverlay = new google.maps.GroundOverlay(
        "https://southernsiteworks.demo.harbingermarketing.com/wp-content/uploads/2021/12/75milesLabel-1.svg",
        imageBounds
    );
...
// https://developers-dot-devsite-v2-prod.appspot.com/maps/documentation/utils/geocoder#q%3D33.256489%252C-83.968325
